...
private:
    ...
    static constexpr double DELAY_FRACTION = 1.2;
...
// </RTEN>
        ...
        const pose_type cam_vio_pose  = pp->get_slow_pose();
        ...
        // time_point render_pose_time = most_recent_frame->render_pose.pose.sensor_time; // <RTEN>
        ...
        // std::chrono::nanoseconds sr_to_display     = _m_clock->now() - render_pose_time; // <RTEN>
        ...
        if (log_count >= LOG_PERIOD) {
            ...
            // const double     latency_srtd       = duration2double<std::milli>(sr_to_display); // <RTEN>
            ...
            // spdlog::get(name)->debug("SR-to-display latency: {} ms", latency_srtd); // <RTEN>
